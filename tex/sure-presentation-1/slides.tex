...
\begin{frame}{Discussion of Proposed Model}
    ...
    \only<2>{For showing equilibrium, solve $dA _{\beta}/dt=0$ in terms of $A _{\beta}$. Substituting this into $dCa/dt$ and simplifying (using CAS), a quadratic is obtained in the form 
    ...
    \only<3>{Then to show the non-existence of limit cycles, consider $\alpha(A _{\beta},Ca)=1$. It can be shown that
    \begin{equation*}
    ...
    \only<4>{Now, using $(A _{\beta}^{*},Ca ^{*})$, notice that 
    \begin{eqnarray*}
