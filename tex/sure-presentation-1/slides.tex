...
\begin{frame}{The Proposed Model}
    ...
    \begin{eqnarray}
        \frac{dA _{\beta}}{dt}&=&a _{1}-r _{1}A _{\beta}+\underbrace{a _{2}\frac{Ca}{Ca+\sigma}}_{\text{Holling Type III}}\\
...
\end{frame}
\section{Discussion}
\begin{frame}{Potential Limitations/Future Directions}
    While global stability has been shown
\end{frame}
