...
\begin{table}
    \begin{tabular}{l|l|l|l}
        ...
        $N$ & $0$ & &\\
        $C$ & $0$ & &\\
        $a _{1}$ & $0.25$ & $c/yr$& \cite{zhang2020mathematical} \\
        $a _{2}$ & $2.89$ & $c/yr$&\\
        $b _{1}$ & $11$ & $c/yr$ & \cite{zhang2020mathematical}\\
        $b _{2}$ & $1000$ & $yr ^{-1}$ & \cite{zhang2020mathematical}\\
        $c _{1}$ & & &\\
        $c _{2}$ & $0.15$ & $yr ^{-1}$&\\
        $c _{3}$ & & &\\
        $d _{1}$ & & &\\
        ...
        $e _{1}$ & $1.67$ & $yr _{-1}$ &\\
        $e _{2}$ & $3.83$ &$yr _{1}$ &\\
        $k _{1}$ & $0.35$ & $yr ^{-1}$ & \cite{zhang2020mathematical}\\
        $k _{2}$ & $500$ & $yr ^{-1}$ & \cite{zhang2020mathematical}\\
        $k _{3}$ & & &\\
        $k _{N}$ & $1.00$ & $C$ &\\
        $k _{C}$ & $169.48$ & $C$ &\\
        $\alpha _{A _{\beta}}$ & & &\\
