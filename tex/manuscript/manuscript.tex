...
\begin{table}
    \begin{tabular}{l|l|l|l}
        ...
        $N$ & & &\\
        $C$ & & &\\
        $a _{1}$ & $0.01$ & $nMs ^{-1}$& \cite{zhang2020mathematical} \\
        $a _{2}$ & & &\\
        $b _{1}$ & $1000$ & $nMs ^{-1}$ & \cite{zhang2020mathematical}\\
        $b _{2}$ & $20$ & $s ^{-1}$ & \cite{zhang2020mathematical}\\
        $c _{1}$ & & &\\
        $c _{2}$ & & &\\
        $c _{3}$ & & &\\
        $d _{1}$ & & &\\
        ...
        $e _{1}$ & & &\\
        $e _{2}$ & & &\\
        $k _{1}$ & $0.000002617$ & $5 ^{-1}$ & \cite{zhang2020mathematical}\\
        $k _{2}$ & $10$ & $5 ^{-1}$ & \cite{zhang2020mathematical}\\
        $k _{3}$ & & &\\
        $k _{4}$ & & &\\
        $k _{5}$ & & &\\
        $\alpha _{A _{\beta}}$ & & &\\
