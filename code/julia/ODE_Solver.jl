...
# Define parameters
@parameters a1=0.25 a2=2.89 b1=11 b2=100 c1=0.25 c2=0.15 c3=0.001 d1=0.01 d2=1 e1=1.67 e2=3.83 e3=1 k1=0.35 k2=0.01 k3=0.000708 k4=1.00 k5=1.00 u1=0 u2=0 u3=0 σ=0.00027 R=1

# Define differential equations
eqs = [D(Aβ) ~ a1 + (a2 * (Ca / (Ca + σ))) - (k1 * Aβ) - (u1 * Aβ)
D(Ca) ~ b1 + (b2 * Aβ) - (k3 * τ) - (u2 * τ)
