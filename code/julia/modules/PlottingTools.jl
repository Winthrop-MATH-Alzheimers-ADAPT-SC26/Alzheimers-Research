...
function make_plot(::ConPlotSep, r1, r2, r3)
    t = r1.t
...
function make_plot(::ConPlotSep2, r1, r2, r3)
    t = r1.t
    sol1, sol2, sol3 = r1.sol, r2.sol, r3.sol
...
function make_plot(::ConPlotSep3Hor, r1, r2, r3)
    t = r1.t
    sol1, sol2, sol3 = r1.sol, r2.sol, r3.sol
    ...
    fig = Figure(size=(2200, 500))

    # --- Col 1: Neuron Loss --- #
    axn = Axis(fig[1, 1],
        title=L"\text{Neuron Loss } (N) \text{ - Control Scenario}",
        xticks=0:10:50,
    ...
    # --- Col 2: Cognitive Decline --- #
    axc = Axis(fig[1, 2],
        title=L"\text{Cognitive Decline } (C) \text{ - Control Scenario}",
        xticks=0:10:50,
        xlabel="Years After Age 50")
    lines!(axc, t, C_base, linestyle=:dash, label="No Treatment")
    lines!(axc, t, C_u1, label=L"C \text{ with only } u_1")
    ...
    # --- Col 3: Combined controls, dual axis --- #
    ax_left = Axis(fig[1, 3],
        title=L"\text{Control Profiles}",
        xticks=0:10:50,
        xlabel="Years After Age 50",
        ylabel=L"u_1, u_3",
        yaxisposition=:left)
    ...
    l1 = lines!(ax_left, t, u1, color=Cycled(2))
    l3 = lines!(ax_left, t, u3, color=Cycled(4))
    l2 = lines!(ax_right, t, u2, color=Cycled(3))
...
function make_plot(::ConPlot, result)
...
function make_plot(::SolPlotComb, result)
...
function make_plot(::SolPlotHor, result)
